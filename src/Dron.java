...
public class Dron extends Aeronave implements Propulsor{
    public Dron(String codigo_del_aparato, LocalDate fecha_de_entrega, String linea_de_montaje, Integer horas_de_trabajo_previstas, Integer horas_de_trabajo_ya_empleadas, Integer capacidad_pasajeros, Double coste, Double precio_venta) {
    ...
    public String propul(){
        String cadena = "Esta aeronave utiliza electricidad.";
        return cadena;
    }
}
